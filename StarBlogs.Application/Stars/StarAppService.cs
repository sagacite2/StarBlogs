...
namespace StarBlogs.Stars
{
    ...
    public class StarAppService : ApplicationService,IStarAppService
    {
        ...
        public StarAppService(IStarRepository starRepository, IRepository<Blog> blogRepository, IRepository<User, long> userRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public PagedResultOutput<StarDto> GetStars(GetStarsInput input)
        {
            ...
            var stars =
                _starRepository
                    ...
                    .PageBy(input)
                    .ToList();
            var ddItems = stars.MapTo<List<StarDto>>();
