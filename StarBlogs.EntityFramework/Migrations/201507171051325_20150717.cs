namespace StarBlogs.Migrations
{
    ...
    public partial class _20150717 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Blog", "StarId", "dbo.Star");
            DropForeignKey("dbo.Star", "CreatorUserId", "dbo.AbpUsers");
            ...
            DropIndex("dbo.Star", new[] { "CreatorUserId" });
            DropIndex("dbo.Blog", new[] { "StarId" });
